...
func CreateMenuActionTableDataSql() (sql string) {
	...
	sql += "(49, 26, 'GET', '/api/category', 'init'),"
	sql += "(50, 26, 'GET', '/api/category/*', 'init'),"
	sql += "(51, 26, 'POST', '/api/category', 'init'),"
	sql += "(52, 26, 'DELETE', '/api/category/*', 'init'),"
	sql += "(53, 26, 'PATCH', '/api/category/used', 'init'),"
	sql += "(54, 26, 'PATCH', '/api/category/sort', 'init'),"

	sql += "(55, 27, 'GET', '/api/site', 'init'),"
